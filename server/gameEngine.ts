...
const DRIVER_ABILITIES: Record<string, DriverAbility> = {
  ...
  'anointed': { name: 'ROYAL DECREE', effect: 'TIME_REFUND', triggerCondition: 'CONDITIONAL', refundAmount: 20.0, description: '+20s if bid near 20s' },
      ...
      if (game.molePlayerId) {
        ...
        if (mole?.socketId) {
          emitToPlayer(mole.socketId, 'protocol_detail', {
            protocol: 'THE_MOLE',
            msg: 'THE MOLE',
            sub: "You are the Mole. Your bid does not impact your time bank. If you win, you lose 2 trophies if you win by MORE than 7.0s.",
