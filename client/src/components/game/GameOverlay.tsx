      ...
      {type && (
        <div className="fixed inset-0 z-50 flex items-end justify-center pointer-events-none p-8 pb-32">
          <motion.div 
            ...
            className={`absolute bottom-32 left-1/2 -translate-x-1/2 flex flex-col items-center justify-center py-6 px-12 rounded-2xl border backdrop-blur-xl shadow-2xl ${getColor()} min-w-[400px] text-center pointer-events-auto`}
            initial="hidden"
            animate="visible"
            exit="exit"
            variants={variants}
